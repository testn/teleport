...
func init() {
	engineFn := func(ec common.EngineConfig) (common.Engine, error) {
		return &Engine{
			EngineConfig: ec,
		}, nil
	}
	common.RegisterEngine(defaults.ProtocolPostgres, engineFn)
	common.RegisterEngine(defaults.ProtocolCockroachDB, engineFn)
}
